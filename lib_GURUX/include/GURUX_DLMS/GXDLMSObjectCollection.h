...
public:
    ...
    virtual CGXDLMSObject* FindByLN(DLMS_OBJECT_TYPE type, std::string& ln);

    virtual CGXDLMSObject* FindByLN(DLMS_OBJECT_TYPE type, unsigned char ln[6]);

    virtual CGXDLMSObject* FindBySN(unsigned short sn);
