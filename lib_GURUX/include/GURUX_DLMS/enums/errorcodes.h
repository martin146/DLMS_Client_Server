...
typedef enum
{
    ...
    //Access Error : ServerConfiguration reports a hardware fault
    DLMS_ERROR_CODE_HARDWARE_FAULT = 1,
    //Access Error : ServerConfiguration reports a temporary failure
    DLMS_ERROR_CODE_TEMPORARY_FAILURE = 2,
    // Access Error : ServerConfiguration reports Read-Write denied
    DLMS_ERROR_CODE_READ_WRITE_DENIED = 3,
    // Access Error : ServerConfiguration reports a undefined object
    DLMS_ERROR_CODE_UNDEFINED_OBJECT = 4,
    // Access Error : ServerConfiguration reports a inconsistent Class or Object
    DLMS_ERROR_CODE_INCONSISTENT_CLASS_OR_OBJECT = 9,
    // Access Error : ServerConfiguration reports a unavailable object
    DLMS_ERROR_CODE_UNAVAILABLE_OBJECT = 11,
    // Access Error : ServerConfiguration reports a unmatched type
    DLMS_ERROR_CODE_UNMATCH_TYPE = 12,
    // Access Error : ServerConfiguration reports scope of access violated
