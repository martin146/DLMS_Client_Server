...
#include "GURUX_DLMS/GXApplicationContextName.h"
#include "GURUX_DLMS/GXDLMSContextType.h"
#include "GURUX_DLMS/GXAuthenticationMechanismName.h"
...
protected:
    virtual DLMS_ACCESS_MODE GetAttributeAccess(CGXDLMSServer *server, CGXDLMSValueEventArg &e);
    virtual DLMS_METHOD_ACCESS_MODE GetMethodAccess(CGXDLMSServer *server, CGXDLMSValueEventArg &e);
