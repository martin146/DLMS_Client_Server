...
0.0-64.96.1.0.255;1,3,4;6,9,10,12,17,18;Ch. $B;ServerConfiguration ID 1, manufacturing number;;;\n\
0.0-64.96.1.1-9.255;1,3,4;6,9,10,12,17,18;Ch. $B;ServerConfiguration ID;;#$(E+1);\n\
...
7.0-64.0.2.3.255;1,3,4;6,9,10,17,18;Ch. $B;ServerConfiguration version;;;\n\
