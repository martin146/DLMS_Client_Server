...
#include "GURUX_DLMS/GXDLMSLimits.h"
#include "GURUX_DLMS/GXPlcSettings.h"
...
class CGXDLMSSettings
{
    ...
    CGXDLMSObjectCollectionE m_AllocatedObjects;
    ...
    CGXDLMSObjectCollectionE m_Objects;
...
public:
    ...
    CGXDLMSObjectCollectionE& GetObjects();
