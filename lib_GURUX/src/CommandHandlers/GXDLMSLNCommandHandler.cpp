...
#include "GURUX_DLMS/CommandHandlers/GXDLMSLNCommandHandler.h"
#include "GURUX_DLMS/GXDLMS.h"
#include "GURUX_DLMS/GXDLMSValueEventCollection.h"
...
#include "GURUX_DLMS/GXDLMSAccessItem.h"
    ...
    CGXDLMSTranslatorStructure* xml)
{
    ...
    if (obj == NULL)
    {
        // ServerConfiguration reports a undefined object.
