...
#include "GURUX_DLMS/OBiscodes.h"
#include "GURUX_DLMS/GXStandardObisCodeCollection.h"
...
const char* CGXDLMSConverter::GetErrorMessage(int error)
{
    ...
    else
    {
        ...
        case DLMS_ERROR_CODE_HARDWARE_FAULT:
            str = "Access Error : ServerConfiguration reports a hardware fault.";
            break;
        case DLMS_ERROR_CODE_TEMPORARY_FAILURE:
            str = "Access Error : ServerConfiguration reports a temporary failure.";
            break;
        case DLMS_ERROR_CODE_READ_WRITE_DENIED:
            str = "Access Error : ServerConfiguration reports Read-Write denied.";
            break;
        case DLMS_ERROR_CODE_UNDEFINED_OBJECT:
            str = "Access Error : ServerConfiguration reports a undefined object.";
            break;
        case DLMS_ERROR_CODE_INCONSISTENT_CLASS_OR_OBJECT:
            str = "Access Error : ServerConfiguration reports a inconsistent Class or Object.";
            break;
        case DLMS_ERROR_CODE_UNAVAILABLE_OBJECT:
            str = "Access Error : ServerConfiguration reports a unavailable object.";
            break;
        case DLMS_ERROR_CODE_UNMATCH_TYPE:
            str = "Access Error : ServerConfiguration reports a unmatched type.";
            break;
        case DLMS_ERROR_CODE_ACCESS_VIOLATED:
            str = "Access Error : ServerConfiguration reports scope of access violated.";
            break;
